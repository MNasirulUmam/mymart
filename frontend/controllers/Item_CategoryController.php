...
use Yii;
use frontend\models\Item_Category;
use frontend\models\Item_CategorySearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * Item_CategoryController implements the CRUD actions for Item_Category model.
 */
class Item_CategoryController extends Controller
{
    ...
    {
        $searchModel = new Item_CategorySearch();
